...
> A lot of the dependencies are registered as `optdepends` because they are expected on the ISO in stable state of release. You can run `sudo ./DEV -h2t -o` to check you have all of them, when not running from the ISO.
