...
Archinstoo supports multiple languages, which depend on translations coming from the community :)
...
Archinstoo validates this by making sure your passwords are ASCII compatible.
